    ...
    function n(t, e, n, s, o, a) {
        ...
        switch (n) {
            case "top":
                return {
                    left: Foundation.rtl() ?
                        l.offset.left - r.width + l.width : l.offset.left,
            ...
            default:
                return {
                    left: Foundation.rtl() ?
                        l.offset.left - r.width + l.width : l.offset.left + o,
                    top: l.offset.top + l.height + s
                };
        }
    }
                    ...
                    value: function() {
                        ...
                        return (
                            ...
                            this.$element.trigger(
                                (n ? "formvalid" : "forminvalid") + ".zf.abide", [this.$element]
                            ),
                            n
                        );
                    }
                    ...
                    value: function(e, i) {
                        ...
                        if (
                            (e
                                ...
                                .addBack()
                                .parent()
                                .addClass("is-active"), !this.options.multiExpand && !i)
                        ) {
                            var s = this.$element
                                .children(".is-active")
                                .children("[data-tab-content]");
                            ...
                            .on("keydown.zf.drilldown", function(i) {
                                ...
                                a.each(function(e) {
                                    ...
                                    Foundation.Keyboard.handleKey(i, "Drilldown", {
                                        ...
                                        up: function() {
                                            return (
                                                n.focus(), !o.is(e.$element.find("> li:first-child > a"))
                                            );
                                        },
                                        down: function() {
                                            return (
        ...
        return (
            _createClass(e, [{
                ...
                },
                {
                    key: "_reposition",
                    value: function(t) {
                        this.usedPositions.push(t ? t : "bottom"), !t && this.usedPositions.indexOf("top") < 0 ?
                    ...
                    value: function() {
                        ...
                        this.options.isRevealed === !0 &&
                            ((this.options.revealOn =
                                    ...
                                    .split("-")[2]),
                                this._setMQChecker()), !this.options.transitionTime == !0 &&
                ...
                },
                {
                    ...
                    value: function() {
                        ...
                        (this.timer = new Foundation.Timer(
                            this.$element, { duration: this.options.timerDelay, infinite: !1 },
                            function() {
                                t.changeSlide(!0);
                            }
                        )),
                ...
                },
                {
                    ...
                    value: function() {
                        ...
                        this.options.animationOut ?
                            ...
                            this.options.closeOnEsc && t(window).off("keydown.zf.reveal"), !this.options.overlay &&
                            this.options.closeOnClick &&
                            ...
                            if (i.length) {
                                ...
                                if (n.length) {
                                    if ((e.selectTab(t(i), !0), e.options.deepLinkSmudge)) {
                                        ...
                                        t("html, body").animate({ scrollTop: s.top },
...
!(function(n, e) {
    ...
    function e(e, a, r, u) {
        ...
        for (
            var n = ["webkit", "moz"], e = 0; e < n.length && !window.requestAnimationFrame;
            ++e
        ) {
            var i = n[e];
            (window.requestAnimationFrame = window[i + "RequestAnimationFrame"]),
